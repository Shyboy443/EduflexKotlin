...
import com.example.ed.databinding.ActivityStudentWeeklyContentBinding
...
class StudentWeeklyContentActivity : AppCompatActivity() {
    
    private lateinit var binding: ActivityStudentWeeklyContentBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityStudentWeeklyContentBinding.inflate(layoutInflater)
    ...
    private fun setupToolbar() {
        ...
        supportActionBar?.title = "Weekly Content"
    ...
    private fun setupRecyclerView() {
        ...
        binding.rvContent.apply {
            layoutManager = LinearLayoutManager(this@StudentWeeklyContentActivity)
        ...
        if (currentWeek > maxUnlockedWeek) {
            ...
            binding.btnCompleteWeek.setOnClickListener {
                if (weeklyContent.quiz != null) {
                    ...
                    Toast.makeText(this, "No quiz available for this week", Toast.LENGTH_SHORT).show()
                }
            }
        }
    }
        ...
        if (progress != null) {
            ...
            if (progress.quizScore > 0) {
                ...
                if (progress.quizScore >= PASSING_SCORE) {
                    binding.tvQuizScore.setTextColor(getColor(R.color.success_green))
                } else {
                    binding.tvQuizScore.setTextColor(getColor(R.color.error_red))
                }
            } else {
    ...
    private fun openContent(contentItem: ContentItem) {
        when (contentItem.type) {
            ...
            ContentType.PRESENTATION -> {
                ...
                Toast.makeText(this, "Opening ${contentItem.title}", Toast.LENGTH_SHORT).show()
            }
        }
